#!/usr/bin/env python3
"""Finalize a private Priority 6 v2 fixture evidence package after cleanup."""
...
def main() -> int:
    ...
    cleanup = {
        ...
        "schema": "filiolae.priority6-v2-distinct-uid-cleanup.v1",
    }
    ...
    manifest = {
        "bounded_claim": "private distinct-UID CPU fixture evidence; no model inference",
        "file_count_excluding_manifests": len(data_files),
        "files": [path.relative_to(package).as_posix() for path in data_files],
        "schema": "filiolae.priority6-v2-distinct-uid-evidence-package.v1",
    }
